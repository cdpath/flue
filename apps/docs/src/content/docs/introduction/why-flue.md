...
- **[Develop & build](/docs/guide/deployment/):** Develop locally, run applications or jobs, and deploy them.
...
See [Sandboxes](/docs/guide/sandboxes/) and [Develop & Build](/docs/guide/deployment/) for more details.
